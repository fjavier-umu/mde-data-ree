 ...
 * <ul>
 *   <li>{@link DML_DDL.impl.CharactersImpl#getN <em>N</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CharactersImpl extends TypeImpl implements Characters {
	/**
	...
	protected EClass eStaticClass() {
		return DML_DDLPackage.Literals.CHARACTERS;
	}
	...
	public void setN(String newN) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DML_DDLPackage.CHARACTERS__N, oldN, n));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DML_DDLPackage.CHARACTERS__N:
				return getN();
		}
