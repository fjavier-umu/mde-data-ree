 ...
 * <ul>
 *   <li>{@link DML_DDL.impl.DatabaseImpl#getDatabaseName <em>Database Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DatabaseImpl extends DataDefinitionImpl implements Database {
	/**
	...
	protected EClass eStaticClass() {
		return DML_DDLPackage.Literals.DATABASE;
	}
	...
	public void setDatabaseName(String newDatabaseName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DML_DDLPackage.DATABASE__DATABASE_NAME, oldDatabaseName, databaseName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DML_DDLPackage.DATABASE__DATABASE_NAME:
